...
ActiveRecord::Schema.define(version: 20150102192616) do
  ...
  add_index "breaks", ["frame_id"], name: "index_breaks_on_frame_id", using: :btree
  add_index "breaks", ["match_id"], name: "index_breaks_on_match_id", using: :btree
  add_index "breaks", ["player_id"], name: "index_breaks_on_player_id", using: :btree
  ...
  add_index "frames", ["match_id"], name: "index_frames_on_match_id", using: :btree
  ...
  create_table "tables", force: true do |t|
    ...
    t.integer  "league_id"
    t.integer  "player_id"
    t.integer  "diff_small_points"
  end

  add_index "tables", ["league_id"], name: "index_tables_on_league_id", using: :btree
  add_index "tables", ["player_id"], name: "index_tables_on_player_id", using: :btree
